...
typedef enum
{
    ...
    ET_COLUMN_TITLE           = 1 << 2,
    ET_COLUMN_ARTIST          = 1 << 3,
    ET_COLUMN_ALBUM_ARTIST    = 1 << 4,
    ET_COLUMN_ALBUM           = 1 << 5,
    ET_COLUMN_YEAR            = 1 << 6,
    ET_COLUMN_RELEASE_YEAR    = 1 << 7,
    ET_COLUMN_DISC_NUMBER     = 1 << 8,
    ET_COLUMN_TRACK_NUMBER    = 1 << 9,
    ET_COLUMN_GENRE           = 1 << 10,
    ET_COLUMN_COMMENT         = 1 << 11,
    ET_COLUMN_COMPOSER        = 1 << 12,
    ET_COLUMN_ORIG_ARTIST     = 1 << 13,
    ET_COLUMN_ORIG_YEAR       = 1 << 14,
    ET_COLUMN_COPYRIGHT       = 1 << 15,
    ET_COLUMN_URL             = 1 << 16,
    ET_COLUMN_ENCODED_BY      = 1 << 17,
    ET_COLUMN_CREATION_DATE   = 1 << 18,
    ET_COLUMN_FILE_TYPE       = 1 << 19,
    ET_COLUMN_FILE_SIZE       = 1 << 20,
    ET_COLUMN_FILE_DURATION   = 1 << 21,
    ET_COLUMN_FILE_BITRATE    = 1 << 22,
    ET_COLUMN_FILE_SAMPLERATE = 1 << 23
} EtColumn;
