...
typedef struct
{
    ...
    GtkWidget *browser_columns_track_number_check;
    GtkWidget *browser_columns_genre_check;
    GtkWidget *browser_columns_comment_check;
    GtkWidget *browser_columns_composer_check;
    GtkWidget *browser_columns_orig_artist_check;
    GtkWidget *browser_columns_orig_year_check;
...
create_preferences_dialog (EtPreferencesDialog *self)
{
    ...
    bind_flags_value("visible-columns", priv->browser_columns_track_number_check);
    bind_flags_value("visible-columns", priv->browser_columns_genre_check);
    bind_flags_value("visible-columns", priv->browser_columns_comment_check);
    bind_flags_value("visible-columns", priv->browser_columns_composer_check);
    bind_flags_value("visible-columns", priv->browser_columns_orig_artist_check);
    bind_flags_value("visible-columns", priv->browser_columns_orig_year_check);
...
et_preferences_dialog_class_init (EtPreferencesDialogClass *klass)
{
    ...
    gtk_widget_class_bind_template_child_private(widget_class, EtPreferencesDialog, browser_columns_track_number_check);
    gtk_widget_class_bind_template_child_private(widget_class, EtPreferencesDialog, browser_columns_genre_check);
    gtk_widget_class_bind_template_child_private(widget_class, EtPreferencesDialog, browser_columns_comment_check);
    gtk_widget_class_bind_template_child_private(widget_class, EtPreferencesDialog, browser_columns_composer_check);
    gtk_widget_class_bind_template_child_private(widget_class, EtPreferencesDialog, browser_columns_orig_artist_check);
    gtk_widget_class_bind_template_child_private(widget_class, EtPreferencesDialog, browser_columns_orig_year_check);
