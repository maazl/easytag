...
typedef enum
{
    ...
    ET_PROCESS_FIELD_SUBTITLE        = 1 << 2,
    ET_PROCESS_FIELD_ARTIST          = 1 << 3,
    ET_PROCESS_FIELD_ALBUM_ARTIST    = 1 << 4,
    ET_PROCESS_FIELD_ALBUM           = 1 << 5,
    ET_PROCESS_FIELD_DISC_SUBTITLE   = 1 << 6,
    ET_PROCESS_FIELD_GENRE           = 1 << 7,
    ET_PROCESS_FIELD_COMMENT         = 1 << 8,
    ET_PROCESS_FIELD_COMPOSER        = 1 << 9,
    ET_PROCESS_FIELD_ORIGINAL_ARTIST = 1 << 10,
    ET_PROCESS_FIELD_COPYRIGHT       = 1 << 11,
    ET_PROCESS_FIELD_URL             = 1 << 12,
    ET_PROCESS_FIELD_ENCODED_BY      = 1 << 13
} EtProcessField;
...
typedef enum
{
    ET_SORT_MODE_ASCENDING_FILEPATH,
    ET_SORT_MODE_DESCENDING_FILEPATH,
    ET_SORT_MODE_ASCENDING_FILENAME,
    ET_SORT_MODE_DESCENDING_FILENAME,
    ET_SORT_MODE_ASCENDING_TITLE,
    ET_SORT_MODE_DESCENDING_TITLE,
    ET_SORT_MODE_ASCENDING_SUBTITLE,
    ET_SORT_MODE_DESCENDING_SUBTITLE,
    ...
    ET_SORT_MODE_ASCENDING_DISC_SUBTITLE,
    ET_SORT_MODE_DESCENDING_DISC_SUBTITLE,
    ET_SORT_MODE_ASCENDING_YEAR,
    ET_SORT_MODE_DESCENDING_YEAR,
    ET_SORT_MODE_ASCENDING_RELEASE_YEAR,
    ET_SORT_MODE_DESCENDING_RELEASE_YEAR,
    ...
    ET_SORT_MODE_ASCENDING_ORIG_YEAR,
    ET_SORT_MODE_DESCENDING_ORIG_YEAR,
...
typedef enum
{
    ...
    ET_COLUMN_TITLE           = 1 << 2,
    ET_COLUMN_SUBTITLE        = 1 << 3,
    ET_COLUMN_ARTIST          = 1 << 4,
    ET_COLUMN_ALBUM_ARTIST    = 1 << 5,
    ET_COLUMN_ALBUM           = 1 << 6,
    ET_COLUMN_DISC_SUBTITLE   = 1 << 7,
    ET_COLUMN_YEAR            = 1 << 8,
    ET_COLUMN_RELEASE_YEAR    = 1 << 9,
    ET_COLUMN_DISC_NUMBER     = 1 << 10,
    ET_COLUMN_TRACK_NUMBER    = 1 << 11,
    ET_COLUMN_GENRE           = 1 << 12,
    ET_COLUMN_COMMENT         = 1 << 13,
    ET_COLUMN_COMPOSER        = 1 << 14,
    ET_COLUMN_ORIG_ARTIST     = 1 << 15,
    ET_COLUMN_ORIG_YEAR       = 1 << 16,
    ET_COLUMN_COPYRIGHT       = 1 << 17,
    ET_COLUMN_URL             = 1 << 18,
    ET_COLUMN_ENCODED_BY      = 1 << 19,
    ET_COLUMN_CREATION_DATE   = 1 << 20,
    ET_COLUMN_FILE_TYPE       = 1 << 21,
    ET_COLUMN_FILE_SIZE       = 1 << 22,
    ET_COLUMN_FILE_DURATION   = 1 << 23,
    ET_COLUMN_FILE_BITRATE    = 1 << 24,
    ET_COLUMN_FILE_SAMPLERATE = 1 << 25
} EtColumn;
